...
nohup Rscript make_data.R 2018 2020 "1" "3" "" "./merged_data/by_city_monthly2.csv" > /home/brazil-death-data/merged_data/by_city_monthly.out &
job2=$!
echo "Starting job $job2"
...
nohup Rscript make_data.R 2018 2020 "4" "6" "" "./merged_data/by_city_monthly4.csv" > /home/brazil-death-data/merged_data/by_city_monthly.out &
job2=$!
echo "Starting job $job2"
...
nohup Rscript make_data.R 2018 2020 "7" "9" "" "./merged_data/by_city_monthly6.csv" > /home/brazil-death-data/merged_data/by_city_monthly.out &
job2=$!
echo "Starting job $job2"
...
nohup Rscript make_data.R 2018 2020 "10" "12" "" "./merged_data/by_city_monthly8.csv" > /home/brazil-death-data/merged_data/by_city_monthly.out &
job2=$!
echo "Starting job $job2"
